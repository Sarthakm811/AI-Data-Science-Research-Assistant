        ...
        setTimeout(() => {
            try {
                ...
                const statistics = numericCols.map(col => {
                    ...
                    // Guard against empty numeric column
                    if (values.length === 0) {
                        return {
                            name: col, mean: 0, median: 0, std: 0, min: 0, max: 0, q1: 0, q3: 0,
                            outlierCount: 0, outlierPercentage: '0', skewness: '0', range: 0, cv: '0', count: 0,
                            distribution: [], values: [], trend: 'symmetric'
                        }
                    }
                    ...
                    const range = max - min
                    const cv = Math.isFinite(mean) && mean !== 0 ? (std / mean) * 100 : 0
                ...
                setAnalyzing(false)
                // Show a basic result even on error
                setResults({
